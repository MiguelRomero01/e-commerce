     ...
     return(
          <div className={HeroStyles.heroSection}>
            <div className={HeroStyles['heroSectionContent-left']}>
              ...
              <p className={HeroStyles.text} data-aos="fade-right" data-aos-delay={animationOcurred? "0": "1800"} data-aos-duration="500">Live for influential and innovative fashion!</p>
              <button className={HeroStyles['main-button']} data-aos="fade-right" data-aos-delay={animationOcurred? "0": "1800"} data-aos-duration="500">Get Started</button>
            </div>

            <div style={{marginBottom:'65vh', marginRight:"-4vmin"}}  data-aos="fade-right" data-aos-duration="500" data-aos-delay={animationOcurred? "0": "1800"}>
              <SocialMedia/>
            </div>
